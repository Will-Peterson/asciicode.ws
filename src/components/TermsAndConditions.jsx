  ...
  return (
    <div className="ac-container">
      ...
      <p>
        ...
        carefully before using the https://www.asciicode.ws website (the
        "Service") operated by ASCIICode.ws ("us", "we", or "our").
      </p>
      <p>
      ...
      <p>
        ...
        are not owned or controlled by ASCIICode.ws.
      </p>
      <p>
        ASCIICode.ws has no control over, and assumes no responsibility for, the
        content, privacy policies, or practices of any third-party web sites or
        services. You further acknowledge and agree that ASCIICode.ws shall not
