...
const PrivacyPolicy = () => {
    return (
        <React.Fragment>
            ...
            <p>
                We use cookies from Google Analytics to measure how users interact with this website's content.
            </p>
            <p>
            ...
            <p>
                If you turn cookies off, some features will be disabled that make your website experience more 
            ...
            <p>
                ...
                parties agree to keep this information confidential. We may also release information when it's release 
            ...
            <p>
                Google, as a third-party vendor, uses cookies to serve advertisements on our website.  Google's use of the 
                DART cookie enables it to serve advertisements to our users based on previous visits to our website on the 
            ...
            <p>
                ...
                <ul>
                    ...
                    <li>Our Privacy Policy link includes the word 'Privacy' and can be easily be found on every page.</li>
            ...
            <p>
                <strong>Does our website allow third-party behavioral tracking?</strong>
            </p>
            <p>
            ...
            <p>
                <strong>In order to be in line with Fair Information Practices we will take the following responsive 
            ...
            <p>
                ...
                but also that individuals have recourse to courts or government agencies to investiage and/or 
            ...
            <p>
                Asciicode.ws' legal basis for collecting and using the personal information described in this 
            ...
            <p>
                <ul>
                    ...
                    <li>When processing your personal information is in Asciicode.ws' legitimate interest</li>
                    <li>Asciicode.ws needs to comply with the law</li>
                </ul>
            </p>
            <p>
                Asciicode.ws will retain your personal information only for as long as is necessary for the 
                purposes set out in the Privacy Policy. We will retain and use your information to the extent 
            ...
            <p>
                Asciicode.ws follows a standard procedure of using log files. These files log visitors when they 
                ...
                number of clicks. These are not linked to any information that is personally indentifiable. 
