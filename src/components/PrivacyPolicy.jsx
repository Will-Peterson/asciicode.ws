  ...
  return (
    <div className="ac-container">
      ...
      <p>
        ...
        concerned with how their 'Personally Identifiable Information' (PPI) is
        being used online. PPI, as described in US privacy law and information
      ...
      <p>
        ...
        website experience more efficient and may not function properly.
      </p>
      <p>
      ...
      <p>
        ...
        our website. Google's use of the DART cookie enables it to serve
        advertisements to our users based on previous visits to our website on
      ...
      <p>
        ...
        government agencies to investiage and/or prosecute non-compliance by
        data processors.
      </p>
      <p>
      ...
      <p>We do not collect your email address.</p>
      <p>
        <strong>
      ...
      <p>
        Asciicode.ws' legal basis for collecting and using the personal
      ...
      <p>
        <ul>
          ...
          <li>
            When processing your personal information is in Asciicode.ws'
            legitimate interest
          </li>
      ...
      <p>
        ...
        systems, please <Link to="contact">contact us</Link>.
      </p>
      <p>
      ...
      <p>
        Asciicode.ws follows a standard procedure of using log files. These
        ...
        linked to any information that is personally indentifiable. The purpose
      ...
      <p>
        ...
        contact us using the <Link to="contact">Contact Us</Link> page.
      </p>
      <p>
        asciicode.ws
        <br />
